...
app.post("/search-download", (req, res) => {
...
app.post("/metadata-download", async (req, res) => {
...
app.get("/onedrive-token", (req, res) => {
	onedrive
		.getAccessToken()
		.then((token) => {
			res.send(token)
...
app.post("/youtube-link-download", (req, res) => {
...
app.post("/metadata-link", async (req, res) => {
